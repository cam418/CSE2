...
public class Enigma1{
  public static void main(String []arg){
   ...
   if(x==7) //when the user enters 7
    ...
    else if(x==23)//when the user enters 33
 ...
 *    and fix the errors)
      ...
      The program runs and correctly gives a percentage, but it only will give
      the remaining proportion for selected percentages. All numbers run when
      inputed, but any String or char will cause the program to fail. 
